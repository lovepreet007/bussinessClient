...
@Injectable()
export class FoodOnlineOrderService {

  constructor(private _http: Http) {
  }

GetFoods(): Observable<FoodDetails>{
return this._http.get('http://localhost:52793/api/Food').map(this.extractDetails).catch(this.handleError);
}
